...
/* Creditos a Astral (https://wa.me/5493804165438) */
...
mobile: MethodMobile, 
browser: opcion == '1' ? ['TheMystic-Bot-MD', 'Safari', '2.0.0'] : methodCodeQR ? ['Alastor-the-radio-bot', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '110.0.5585.95'],
auth: {
creds: state.creds,
...
const directories = ['./Radiosession/', './jadibts/']
...
if (reason == 405) {
await fs.unlinkSync("./Radiosession/" + "creds.json")
...
global.reloadHandler = async function(restatConn) {
  ...
  conn.welcome = '𝐁𝐈𝐄𝐍𝐕𝐄𝐍𝐈𝐃𝐎 @user 𝐀 𝐄𝐒𝐓𝐀 𝐓𝐑𝐀𝐍𝐒𝐌𝐈𝐒𝐈𝐎𝐍, 𝐁𝐈𝐄𝐍𝐕𝐄𝐍𝐈𝐃𝐎 𝐀 @subject ';
  conn.bye = '𝐀𝐃𝐈𝐎𝐒 𐂂 @user 𐂂𝐆𝐑𝐀𝐂𝐈𝐀𝐒 𝐏𝐎𝐑 𝐇𝐀𝐁𝐄𝐑 𝐒𝐈𝐃𝐎 𝐏𝐀𝐑𝐓𝐄 𝐃𝐄 𝐄𝐒𝐓𝐀 𝐓𝐑𝐀𝐍𝐒𝐌𝐈𝐒𝐈𝐎𝐍 :) ';
  conn.spromote = '*@user 𝐚𝐡𝐨𝐫𝐚 𝐞𝐬 𝐮𝐧 𝐨𝐯𝐞𝐫𝐥𝐨𝐫𝐝.*';
  conn.sdemote = '*@user 𝐲𝐚 𝐧𝐨 𝐞𝐬 𝐮𝐧 𝐨𝐯𝐞𝐫𝐥𝐨𝐫𝐝.*';
  conn.sDesc = '*𝐬𝐞 𝐜𝐚𝐦𝐛𝐢𝐨 𝐥𝐚 𝐝𝐞𝐬𝐜𝐫𝐢𝐩𝐜𝐢𝐨𝐧 𝐝𝐞 𝐞𝐬𝐭𝐞 𝐠𝐫𝐮𝐩𝐨.*';
  conn.sSubject = '*𝐬𝐞 𝐜𝐚𝐦𝐛𝐢𝐨 𝐞𝐥 𝐧𝐨𝐦𝐛𝐫𝐞 𝐝𝐞𝐥 𝐠𝐫𝐮𝐩𝐨.*';
  conn.sIcon = '*𝐬𝐞 𝐡𝐚 𝐜𝐚𝐦𝐛𝐢𝐚𝐝𝐨 𝐥𝐚 𝐢𝐦𝐚𝐠𝐞𝐧 𝐝𝐞𝐥 𝐠𝐫𝐮𝐩𝐨 .*';
  conn.sRevoke = '*𝐞𝐥 𝐞𝐧𝐥𝐚𝐜𝐞 𝐝𝐞 𝐢𝐧𝐯𝐢𝐭𝐚𝐜𝐢𝐨𝐧 𝐟𝐮𝐞 𝐫𝐞𝐧𝐨𝐯𝐚𝐝𝐨.*';
...
setInterval(async () => {
  ...
  const bio = `𝐓𝐈𝐄𝐌𝐏𝐎 𝐀𝐋 𝐀𝐈𝐑𝐄: ${uptime} |𝐀𝐋𝐀𝐒𝐓𝐎𝐑 𝐁𝐘 𐂂𝐀𝐒𝐓𝐑𝐀𝐋𐂂 `;
