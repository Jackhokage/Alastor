...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*Advertencia*', body: '𝐀𝐋𝐀𝐒𝐓𝐎𝐑 - 𝐎𝐅𝐂', thumbnail: imagen1, sourceUrl: 'https://www.paypal.me/alexx86671'}}}}, aa);
