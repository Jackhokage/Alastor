...
const sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por ALS, tu seras Jotchua - Bot.`;
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  try {
      ...
      try {
        ...
        throw `*𝐄𝐑𝐑𝐎𝐑 𝐄𝐍 𝐌𝐈 𝐑𝐀𝐃𝐈𝐎, 𝐈𝐍𝐓𝐄𝐍𝐓𝐀𝐋𝐎 𝐌𝐀𝐒 𝐓𝐀𝐑𝐃𝐄*`;
     }}
    }}
   }}
  }}
...
handler.command = /^(chatvoz|alastorvoz)$/i;
